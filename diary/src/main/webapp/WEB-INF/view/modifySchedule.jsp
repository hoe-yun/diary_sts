...
<body>
	<div class="container col-lg-3" align="center">
		...
		<a href="${pageContext.request.contextPath }/scheduleOne?targetYear=${targetYear}&targetMonth=${targetMonth}&targetDate=${targetDate}" class="btn btn-outline-dark">뒤로</a>
	</div>
</body>
</html>